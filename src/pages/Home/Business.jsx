...
const Business = () => {
  return (
    <>
      <div className="pt-5 flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-20">
        <div className="">
          <h2 className="text-4xl md:text-left text-center md:text-[60px] font-poppins font-bold  leading-none pt-28 lg:pb-28">
            We make your
            <span>
              <img
            ...
            <br className="hidden md:block" /> business stand out Things.
          </h2>
        </div>
      ...
      <div className="pt-10 flex flex-col md:flex-row justify-center  pb-16">
        ...
        {/* Right Side  */}
        <div className=" w-[90%] md:w-80 mx-auto mt-5 bg-black border rounded-3xl text-white">
