    ...
    <>
      <div className="pt-5 flex flex-col lg:flex-row justify-center  items-center gap-8 lg:gap-20">
        <div className="md:px-5">
          <h2 className="text-4xl lg:text-left  text-center md:text-[60px] font-poppins font-semibold  leading-none pt-28 lg:pb-28">
            <span className=" gap-3">
              We make your
              <img
                className="h-14  lg:inline  hidden ml-3"
