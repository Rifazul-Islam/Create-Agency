...
const Quality = () => {
  ...
  return (
    <div className="bg-[#FFFFF5] md:pb-6 lg:pb-20 pt-7 lg:pt-32 p-4 flex  flex-col lg:flex-row  lg:px-32 gap-4">
      {/* left side  */}
      <div>
        <h2 className="md:w-[700px] lg:text-left text-center w-full lg:text-[60px] text-4xl font-semibold font-poppins leading-none">
          Our high-quality
          <span>
            <img
              className="h-14 pt-3 hidden lg:inline ml-3 -mt-1"
