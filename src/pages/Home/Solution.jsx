...
const Solution = () => {
  return (
    <div className="bg-[#FFFFF5] px-4 lg:px-20">
      <h2 className="text-center font-poppins text-[40px] md:text-[60px] font-bold  leading-none md:pt-28 py-14 md:pb-28">
        We provide effective <br /> design solutions
        <span>
          <img
            className="h-14 pt-3 md:inline  hidden"
