...
const Reivews = () => {
  return (
    <div className="bg-[#FFFFF5] pb-10 lg:px-32 pt-5 p-4">
      ...
      <h2 className="text-center lg:text-[60px] font-semibold font-poppins text-4xl  leading-none lg:pt-20 pt-12 pb-14 lg:pb-28">
        Clients are always <br className="lg:block hidden" />
        <p className="flex items-center justify-center gap-3">
          <span>satisfied with us</span>
          <span>
            <img
              className="h-14 pt-2 hidden lg:inline pl-0"
