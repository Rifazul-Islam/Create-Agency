    ...
    <div className="bg-[#FFFFF5]">
      <div className="bg-black py-[200px]">
        ...
        <div className="flex justify-center text-white gap-2 text-2xl font-semibold items-center font-poppins pt-8">
          ...
          <span className="text-[#B3F747]">Service </span>
        </div>
      </div>

      {/* product Area  */}
      <div className="px-8 lg:px-20">
        <h2 className="text-center  md:text-[60px] font-bold font-poppins text-4xl  leading-none pt-28 pb-10 lg:pb-28">
        ...
        <div className="pb-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          ...
          <div className="card  border-2 border-black p-4 mx-auto hover:bg-blue-300">
            ...
            <div>
              <h2 className="text-2xl pt-2 pb-1 font-semibold">
                Graphic Design
              </h2>
          ...
          <div className="card  border-2 border-black p-4 mx-auto hover:bg-blue-300">
            ...
            <div>
              ...
              <p className="text-md font-sans font-medium">
                ...
                enhance the usability and accessibility of digital products &
                app.
              </p>
              <div className="card-actions justify-start pt-4 pb-2">
                <button className="btn btn-active btn-ghost">
      ...
      <div className="mb-10">
        <div className="px-8 lg:px-20">
          <h2 className="text-center  md:text-[60px] font-bold font-poppins text-4xl  leading-none pt-28 pb-10 lg:pb-28">
            These FAQs help <br /> clients learn about us
            <span>
              <img
                className=" hidden md:h-14 pt-3 md:inline"
                src="data:image/png;base64,"
                alt=""
              />
            </span>
