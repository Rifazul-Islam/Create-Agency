...
const Service = () => {
  return (
    <div className="bg-[#FFFFF5]">
      ...
      {/* product Area  */}
      <h2 className="text-center font-poppins text-[40px] md:text-[60px] font-semibold lg:font-bold leading-none md:pt-28 py-14 md:pb-28">
        We provide effective <br /> design solutions
        <span>
          <img
            className="h-14 pt-3 lg:inline  hidden"
      ...
      <div className="mb-10">
        <div className="px-8 lg:px-20">
          <h2 className="text-center md:text-5xl  lg:text-[60px] font-semibold lg:font-bold  font-poppins text-3xl  leading-none pt-28 pb-10 lg:pb-28">
