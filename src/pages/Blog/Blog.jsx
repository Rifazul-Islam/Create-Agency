  ...
  return (
    <div className="bg-[#FFFFF5]">
      ...
      <div className="grid lg:grid-cols-3 gap-4 my-10  lg:px-20 px-4">
        <div className="col-span-2">
          ...
          <div className="border overflow-hidden rounded-xl p-2 border-black">
            <img
              className="transition lg:h-96 lg:w-full duration-500 rounded-xl hover:scale-110"
            ...
            <div>
              ...
              <Link to="/blog_details">
                <button className="btn btn-active text-lg font-semibold font-inter mb-3">
          ...
          <div className=" border mt-8 overflow-hidden rounded-xl p-2 border-black">
            <img
              className="transition lg:h-96 lg:w-full duration-500 rounded-xl hover:scale-110"
              src="https://aximo-react.vercel.app/assets/blog5-CJktv7EC.png"
              alt=""
            />
          ...
          <div className="border mt-8 overflow-hidden rounded-xl p-2 border-black">
            <img
              className="transition lg:h-96 lg:w-full duration-500 rounded-xl hover:scale-110"
              src="https://aximo-react.vercel.app/assets/blog4-D6S-aoIu.png"
              alt=""
            />
      ...
      <div className="my-14 ml-5 flex  gap-4 items-center justify-center font-inter text-lg ">
        ...
        <button className=" hover:bg-[#BEF264] border-[1px] border-black hover:border-none rounded-full w-14 h-14">
          2
        </button>
