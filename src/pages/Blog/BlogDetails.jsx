      ...
      <div className="grid lg:grid-cols-3 lg:px-20 px-3 py-14 gap-4 bg-[#FFFFF5]">
        ...
        <div className="col-span-2 ">
          <div className="overflow-hidden rounded-xl p-2 border-black">
            <img
              className="transition h-96 md:w-full  duration-500 rounded-xl hover:scale-110"
              src="https://aximo-react.vercel.app/assets/blog3-B6u1nT1Z.png"
              alt=""
            />
            ...
            <div className="mt-10">
              ...
              <span className="pl-3 font-inter font-medium">
                Septembar 10, 2024
              </span>
            </div>
            ...
            {/* Some H1 and Text */}
            <div>
              <h2 className="text-2xl font-bold font-poppins mt-5">
                Learn these five high-income skills to build your one-person.
              </h2>

              <p className="text-md font-inter my-5">
                By definition, most high-value skill stacks can’t be taught in
                schools. If the masses could easily access them, they would not
                be high-value skills anymore. You would become replaceable. And
                value comes from scarcity.
              </p>

              <div className="mt-5">
                <h3 className="font-poppins text-2xl font-bold">
                  1. Codeing Solution, How To write Box
                </h3>
                <p className="mt-5 font-inter text-md">
                  It seems like you're asking for a description of how to modify
                  text in a box using Tailwind CSS. Here's a breakdown of how to
                  control and modify text inside a box, including font size,
              ...
              <div className="mt-8">
                ...
                <p className="mt-5 font-inter text-md">
                  Strong copywriting and content creation skills are essential
                  for creating persuasive, engaging, and valuable content for
                  websites, blogs, marketing materials, and social media.
                </p>
                <p className="mt-10">
                  While these skills can help you build a one-person business
                  and increase your income potential, it's changing market
                  trends. Additionally, starting and growing a business often
                  involves more than just one skill, so consider a holistic
                  approach to building your business and wealth.
                </p>
              </div>
              ...
              <div className="border-t-[1px] border-b-[1px] p-3 py-5 mt-10 border-[#b9b9b0] flex items-center justify-between ">
                <div className="flex items-center gap-4 md:flex-row flex-col">
                  ...
                  <button className="btn text-[#686867] font-inter rounded-full text-lg  bg-slate-100 hover:bg-[#BEF264]">
                    Marketing
                  </button>
                  <button className="btn text-[#686867] ml-4 font-inter text-lg rounded-full  bg-slate-100 hover:bg-[#BEF264]">
                    Busnisses
                  </button>
                </div>

                <div className="flex items-center gap-8">
                  <p className="flex items-center gap-1.5 font-inter font-medium text-[20px]">
              ...
              <div>
                <div>
                  <h2 className="text-2xl font-poppins font-semibold py-8">
                    Comments :
                  </h2>
                  ...
                  <div className="flex md:flex-row flex-col justify-center gap-8 ">
                    ...
                    <div className="font-inter">
                      <span className="flex md:flex-row flex-col justify-between text-lg font-poppins font-semibold">
                        <h3> Rory Smith</h3>
                        <span className="text-[17px]"> Reply</span>
                      </span>
                      ...
                      <div className="border-t-[1px] mt-6">
                        ...
                        <div className=" md:flex-row flex-col flex justify-center gap-8 pt-6 ">
                          ...
                          <div className="font-inter">
                            <span className="flex justify-between text-lg font-poppins font-semibold">
                              <h3> Ricky Smith</h3>
                              <span className="text-[17px]"> Reply</span>
                            </span>
                            <p className="font-inter pb-6">
                              Septembar 11, 2024
                            </p>
                            <p>
          ...
          <div className="mt-10">
            <h2 className="text-2xl py-4 font-inter font-semibold">
              Leave a Comments :
            </h2>
            ...
            <div className="border-[1px] border-black rounded-lg p-3 px-10 pb-10 ">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <input
                  className=" border-b-[1px] bg-[#FFFFF5] px-14 py-1 hover:border-slate-600 border-slate-600"
                  type="text"
                  placeholder="Your Name"
                />
                <input
                  className=" border-b-[1px] bg-[#FFFFF5] pt-5 md:pt-0  px-14 py-1 hover:border-slate-600 border-slate-600"
                  type="text"
              ...
              <textarea
                className="textarea textarea-bordered border-b-[1px] border-black w-full px-8 my-12 h-48 bg-[#FFFFF5]"
                placeholder="Write Your Comments"
              ></textarea>

              <button className="bg-slate-800 btn hover:bg-[#BEF264]  font-inter hover:text-black  bg- text-white rounded-lg">
                Send Message
              </button>
            </div>
          </div>
        ...
        <div className="col-span-2 lg:col-span-1  p-4">
          ...
          <div className="border-[1px] p-8  mt-10 rounded-lg border-black ">
            ...
            <button className="btn text-gray-700 mt-4 md:ml-3 font-inter text-lg  bg-slate-300 hover:bg-[#BEF264]">
              Solutions
            </button>
